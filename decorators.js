...
class DarkThemeDecorator {
    ...
    apply() {
        ...
        return {
            ...
            btnOutlineText: '#00bfff',
            btnOutlineBorder: '#00bfff',
            btnOutlineHoverBg: '#00bfff',
...
class LightThemeDecorator {
    ...
    apply() {
        ...
        return {
            ...
            borderColor: '#ce93d8',
            navbarBg: 'linear-gradient(135deg, #ffffff 0%, #f3e5f5 100%)',
            navbarBorder: '#ce93d8',
            searchBg: '#ffffff',
            searchBorder: '#ce93d8',
            btnBg: 'linear-gradient(45deg, #9c27b0, #7b1fa2)',
            btnHoverShadow: '0 8px 25px rgba(156, 39, 176, 0.4)',
            btnShadow: '0 4px 15px rgba(156, 39, 176, 0.3)',
            statsBg: 'linear-gradient(45deg, #9c27b0, #7b1fa2)',
            statsText: '#ffffff',
            tableBg: '#ffffff',
            tableText: '#4a148c',
            tableHeaderBg: 'linear-gradient(135deg, #9c27b0 0%, #7b1fa2 100%)',
            tableHeaderText: '#ffffff',
            tableBorder: '#ce93d8',
            tableHoverBg: '#f3e5f5',
            navLinkColor: '#6a1b9a',
            navLinkHoverBg: 'rgba(156, 39, 176, 0.1)',
            ...
            modalBg: '#ffffff',
            modalText: '#4a148c',
            modalHeaderBg: 'linear-gradient(45deg, #9c27b0, #7b1fa2)',
            modalHeaderText: '#ffffff',
            footerText: '#6a1b9a',
            loadingText: '#9c27b0',
            paginationBg: '#ffffff',
            paginationText: '#6a1b9a',
            paginationBorder: '#ce93d8',
            paginationHoverBg: '#f3e5f5',
            paginationActiveBg: '#9c27b0',
            paginationActiveText: '#ffffff',
            btnDangerBg: 'linear-gradient(45deg, #e91e63, #c2185b)',
            btnWarningBg: 'linear-gradient(45deg, #ff9800, #f57c00)',
            btnDangerShadow: '0 2px 8px rgba(233, 30, 99, 0.3)',
            btnWarningShadow: '0 2px 8px rgba(255, 152, 0, 0.3)',
            btnDangerHoverShadow: '0 4px 12px rgba(233, 30, 99, 0.4)',
            btnWarningHoverShadow: '0 4px 12px rgba(255, 152, 0, 0.4)',
            btnOutlineBg: '#ffffff',
            btnOutlineText: '#9c27b0',
            btnOutlineBorder: '#9c27b0',
            btnOutlineHoverBg: '#9c27b0',
            btnOutlineHoverText: '#ffffff'
        };
    }
}
